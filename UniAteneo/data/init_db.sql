...
CREATE TABLE IF NOT EXISTS employees ( id integer NOT NULL PRIMARY KEY,  name    text, designation text,     manager integer, hired_on    date,     salary  integer, commission  float,    dept    integer);
